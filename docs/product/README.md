...
- [settings/README.md](settings/README.md): player preferences, hotbar opt-out, and language selection
- [tips/README.md](tips/README.md): hourly multilingual command discovery tips
