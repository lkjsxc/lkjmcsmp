...
This section is the player-facing contract for commands, menus, economy, social systems, and progression.

## Read This Section When

- You add or change gameplay behavior.
- You add or rename commands.
- You change GUI flows or labels.

## Child Index

- [commands/README.md](commands/README.md): command semantics and argument contracts
