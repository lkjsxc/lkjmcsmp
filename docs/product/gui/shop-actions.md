...
1. **Convert Cobblestone** (slot `45`): consumes all cobblestone in inventory and converts to Cobblestone Points.
...
5. On success, the shop list refreshes and the player sees the new Cobblestone Points balance.
