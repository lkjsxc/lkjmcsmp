...
- Hotbar setting disable removes the token immediately without waiting for death or respawn.
...
- Achievement GUI and command list text render through the player's selected language.
