...
Establish a docs-first Folia plugin repository where all contracts are explicit and implementation follows those contracts.
...
2. Deterministic compose verification.
3. Small cohesive source files.
4. Frequent coherent commits.
